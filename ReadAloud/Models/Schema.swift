...
/// V3 — the live models in `Models.swift`. Adds `LearningAssets.userEditedAt`
/// (D7 edited-provenance).
...
typealias ReadAloudSchema = ReadAloudSchemaV3

enum ReadAloudMigrationPlan: SchemaMigrationPlan {
    static var schemas: [any VersionedSchema.Type] {
        [ReadAloudSchemaV1.self, ReadAloudSchemaV2.self, ReadAloudSchemaV3.self]
    }
